...
pub enum TokenName {
    ...
    #[cfg_attr(
        feature = "native",
        serde(rename = "T_AMPERSAND_FOLLOWED_BY_VAR_OR_VARARG")
    )]
    ...
    #[cfg_attr(
        feature = "native",
        serde(rename = "T_AMPERSAND_NOT_FOLLOWED_BY_VAR_OR_VARARG")
    )]
    ...
    /**
     * Syntax: `??=`
     * Reference: [`assignment operators`](https://www.php.net/manual/en/language.operators.assignment.php) (available as of PHP 7.4.0)
     */
    #[cfg(feature = "php_7_4")]
    ...
    /**
     * Syntax: `fn`
     * Reference: [`arrow functions`](https://www.php.net/manual/en/functions.arrow.php) (available as of PHP 7.4.0)
     */
    #[cfg(feature = "php_7_4")]
    ...
    /**
     * Syntax: `::`
     * Reference: [`::`](https://www.php.net/manual/en/language.oop5.paamayim-nekudotayim.php). Also defined as [`T_DOUBLE_COLON`](https://www.php.net/manual/en/tokens.php#constant.t-double-colon).
     */
     ...
     * Reference: identifiers, e.g. keywords like parent and self, function names, class names and more are matched. See also [`T_CONSTANT_ENCAPSED_STRING`](https://www.php.net/manual/en/tokens.php#constant.t-constant-encapsed-string).
     */
